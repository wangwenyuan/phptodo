...
class TDVERIFY
{
    ...
    //
    private $sekey = "PHPTODO";

    // 验证码字体颜色
    public function __construct($config = array())
    {
        $this->config = array_merge($this->config, $config);
        $this->sekey = $this->config["sekey"];
    }
    ...
    public function entry($id = '')
    {
        ...
        // 验证码使用随机字体
        $ttfPath = dirname(__FILE__) . '/TDVERIFY/' . ($this->useZh ? 'zhttfs' : 'ttfs') . '/';
    ...
    {
        $path = dirname(__FILE__) . '/TDVERIFY/bgs/';
        $dir = dir($path);
